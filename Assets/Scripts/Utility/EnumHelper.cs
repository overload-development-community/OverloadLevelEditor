	...
	public static bool EnumTryParse( Type type, string input, out object value )
	{
		...
		foreach( string tok in tokens ) {
			...
			switch( Convert.GetTypeCode( tokenValue ) ) {
				...
				case TypeCode.Int64:
				case TypeCode.SByte:
					tokenUl = (ulong)Convert.ToInt64( tokenValue, System.Globalization.CultureInfo.InvariantCulture );
					break;
				...
				default:
					tokenUl = Convert.ToUInt64( tokenValue, System.Globalization.CultureInfo.InvariantCulture );
					break;
			}
